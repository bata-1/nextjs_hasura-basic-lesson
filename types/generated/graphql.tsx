...
/** columns and relationships of "profile" */
export type ProfileProfile_UsersArgs = {
...
/** columns and relationships of "profile" */
export type ProfileProfile_Users_AggregateArgs = {
  distinct_on?: Maybe<Array<Profile_Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Profile_Users_Order_By>>;
...
/** columns and relationships of "profile" */
export type ProfileUsers_AggregateArgs = {
  distinct_on?: Maybe<Array<Users_Select_Column>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
  order_by?: Maybe<Array<Users_Order_By>>;
...
export type GetIdsQueryVariables = Exact<{ [key: string]: never; }>;
...
export const GetIdsDocument = gql`
    query GetIds {
  users(order_by: {created_at: desc}) {
    id
  }
 ...
 * __useGetIdsQuery__
 *
 * To run a query within a React component, call `useGetIdsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetIdsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetIdsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetIdsQuery(baseOptions?: Apollo.QueryHookOptions<GetIdsQuery, GetIdsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetIdsQuery, GetIdsQueryVariables>(GetIdsDocument, options);
      }
export function useGetIdsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetIdsQuery, GetIdsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetIdsQuery, GetIdsQueryVariables>(GetIdsDocument, options);
        }
export type GetIdsQueryHookResult = ReturnType<typeof useGetIdsQuery>;
export type GetIdsLazyQueryHookResult = ReturnType<typeof useGetIdsLazyQuery>;
export type GetIdsQueryResult = Apollo.QueryResult<GetIdsQuery, GetIdsQueryVariables>;
